...
public final class BeanLocator {
     ...
     * 缺省配置文件名称.
     */
    private static final String DEFAULT_CONFIGURATION_FILENAME = "applicationContext-env.xml";
    ...
    public static void main(String[] args) {
    	ConstantUtils cityInfoService = (ConstantUtils)BeanLocator.getInstance().getBean("toolsUtils");
        System.out.println(cityInfoService.getSysEnvironment().get("pageSize").toString());
    }
}
